...
import type { ConvertStageEvent } from '@codify/contracts'
import { AiEnhanceService } from '../../aiEnhance/aiEnhanceService.ts'
import { createConvertProgressReporter, type ConvertProgressReporter } from '../../shared/convertProgress.ts'
import { upsertInstrumentationPackets } from '../../../sourceInsight/insight/instrumentationStore.ts'
...
type ConvertProgressSink = (event: ConvertStageEvent) => void
