...
import { AuthGuard } from '../../../platform/auth/authGuard.ts'
import { CONVERT_PROGRESS_LABELS } from '../../shared/convertProgress.ts'
...
type ConvertStreamEvent =
  | { type: ConvertStageEvent['stage']; label: string }
